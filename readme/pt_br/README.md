...
<img src="../app.gif" width="40%"/> <img src="../app_watch.gif" width="40%"/>
        ...
        <li>Interface flutuante;
          <ul>
              <li>Menu (Parar, pausar, screenshot, desenhar, minimizar, fechar, tempo, tempo limite, câmera);</li>
               ...
               <li>Imagem;</li>
               <li>Atalhos de apps;</li>
               <li>Atalho do botão iniciar(clique e segure o botão de iniciar para adicioná-lo).</li>
          </ul>
        </li>
  ...
  <tr>
    <td valign="top">
      <ul>
        ...
        <li>Sobreposição flutua: Usado para mostrar o botão de atalho para iniciar (requisitada somente se for usada):
          <ul>
...
##
### Baixar os apks¹ ² ³ ⁴
[![apk](https://img.shields.io/badge/celular-v1.9.1-FBD75B?logo=data:image/svg%2bxml;base64,)](https://github.com/hms-douglas/kapture/tree/master/dist/apks/phone)
...
<table>
  ...
  <tr>
    <td valign="top">
      <b>v1.9.1</b>
      <ul>
         <li>Resolução 2160p adicionada;</li>
         <li>Qualidade 60 Mbps adicionada;</li>
         <li>Removida a opção de baixar atualizações, agora o usuário é levado à pasta dist no github;</li>
         <li>Pequena correção na tradução para PT-BR.
      </ul>
      <b>v1.9.0</b>
      <ul>
         <li>Botão de atalho flutuate para iniciar adicionado (clique e segure o botão de iniciar para adicioná-lo);</li>
         <li>Opção de não combinar o áudio interno com a captura adicionada;</li>
         <li>Mensagem de configuração restrita adicionada ao popup de permissão;</li>
         <li>Mensagens de log adicionadas;</li>
