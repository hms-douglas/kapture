...
public class ListStorage {
    ...
    public static class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
        ...
        public Adapter(Context ctx, boolean isLastFromGroup) {
            ...
            this.ITEMS.add(new StorageItem(R.color.storage_other, R.string.storage_other, 0));
            this.ITEMS.add(new StorageItem(R.color.storage_kaptures, R.string.storage_kaptures, 0));
            this.ITEMS.add(new StorageItem(R.color.storage_cache, R.string.storage_cache, 0));
            this.ITEMS.add(new StorageItem(R.color.storage_free, R.string.storage_free, 0));
