...
public class KSettings {
    ...
    public static final int[] VIDEO_RESOLUTIONS = new int[]{-1, 2160, 1440, 1080, 720, 640, 540, 480, 360, 240},
                              VIDEO_QUALITIES = new int[]{60000000, 16000000, 14000000, 12000000, 10000000, 8000000, 6000000, 4000000, 2000000, 1000000},
    ...
    private int[] getSize(Context ctx, int orientation) {
        ...
        if(orientation == Configuration.ORIENTATION_PORTRAIT) {
            Log.e(TAG, "getSize1: " + videoResolutionUsing + "x" + scaled);

            return new int[]{videoResolutionUsing, scaled};
        }

        Log.e(TAG, "getSize2: " + scaled + "x" + videoResolutionUsing);
