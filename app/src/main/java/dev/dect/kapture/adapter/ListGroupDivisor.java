...
public class ListGroupDivisor {
    ...
    public static class Adapter extends RecyclerView.Adapter<ListGroupDivisor.Adapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public ListGroupDivisor.Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull ListGroupDivisor.Adapter.MyViewHolder holder, int position) {
