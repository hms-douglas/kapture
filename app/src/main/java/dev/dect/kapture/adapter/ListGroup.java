...
public class ListGroup {
    ...
    public static class Adapter extends RecyclerView.Adapter<ListGroup.Adapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public ListGroup.Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull ListGroup.Adapter.MyViewHolder holder, int position) {
