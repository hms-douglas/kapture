...
<img src="readme/app.gif" width="40%"/> <img src="readme/app_watch.gif" width="40%"/>
  ...
  <tr>
      ...
      <ul>
        ...
        <li>Floating UI;
            <ul>
               ...
               <li>Image;</li>
               <li>App shortcuts;</li>
               <li>Start button shortcut (click and hold the start button to add it).</li>
            </ul>
         </li>
    ...
    <td valign="top">
      <ul>
        ...
        <li>Capture internal audio (if the app that is playing the audio allows it to be captured / NOT RECOMMEND TO DO ON WATCH!):
          <ul>
              <li>Capture in mono or stereo.</li>
          </ul>
        </li>
  ...
  <tr>
    <td valign="top">
      <ul>
        ...
        <li>Overlay (Appear on top): Used to show a start button shortcut (requested only if used):
          <ul>
            <li>android.permission.SYSTEM_ALERT_WINDOW</li>
          </ul>
        </li>
        <li>Other: Used for general purposes:
          <ul>
...
[![apk](https://img.shields.io/badge/phone-v1.9.1-FBD75B?logo=data:image/svg%2bxml;base64,)](https://github.com/hms-douglas/kapture/tree/master/dist/apks/phone)
[![apk](https://img.shields.io/badge/watch-v1.0.0-FBD75B?logo=data:image/svg%2bxml;base64,)](https://github.com/hms-douglas/kapture/tree/master/dist/apks/watch)
...
³ Link to all phone versions (>= 1.5.0) can be found <a href="https://github.com/hms-douglas/kapture/blob/master/dist/all.json" target="_blank" rel="noreferrer">here</a> and to all watch versions <a href="https://github.com/hms-douglas/kapture/blob/master/dist/all_watch.json" target="_blank" rel="noreferrer">here</a>;
</br>
...
<table>
  ...
  <tr>
    <td valign="top">
      <b>v1.9.1</b>
      <ul>
         <li>Added 2160p resolution;</li>
         <li>Added 60 Mbps quality;</li>
         <li>Added 60 Mbps quality;
         <li>Removed the option to download updates, now the user is redirected to the dist folder on github;</li>
         <li>Fixed small translation error in PT-BR.
      </ul>
      <b>v1.9.0</b>
      <ul>
         <li>Added a floating button shortcut (click and hold the start button to add it);</li>
         <li>Added option to not merge the internal audio into the final video;</li>
         <li>Added "Allow restricted settings" message to permission popup;</li>
         <li>Log messages added;</li>
         <li>Bug fix.</li>
      </ul>
      <b>v1.8.1</b>
      <ul>
         <li>Code logic fixed.</li>
      </ul>
      <b>v1.8.0</b>
      <ul>
         <li>Internal file picker added;</li>
         <li>Support to SD card and dual message storage added.</li>
      </ul>
      <b>v1.7.0</b>
      <ul>
         <li>Watch installer added;</li>
         <li>Minor UI fix.</li>
      </ul>
      <b>v1.6.0</b>
      <ul>
         <li>Fixed a bug where the app crashes while resuming if the internal audio is not being captured;</li>
         <li>QRCode shortcut added to WiFi Share;</li>
         <li>Wear OS support added (watch);</li>
